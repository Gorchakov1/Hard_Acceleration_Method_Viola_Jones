...
module  int2float_altbarrel_shift_fof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //int2float_altbarrel_shift_fof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2float_altfp_convert_98n
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	int2float_altbarrel_shift_fof   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //int2float_altfp_convert_98n
//VALID FILE
...
module int2float (
	...
	int2float_altfp_convert_98n	int2float_altfp_convert_98n_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
